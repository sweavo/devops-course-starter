...
from todo_app.data import storage_mongo, storage_trello
from todo_app.ViewModel import ViewModel


def test_get_done_items_trello():
...
def test_get_todo_items_trello():
    """! This tests assumes what persistence layer will return into ViewModel"""
    A, B, C, D = (
        storage_trello.Card(1, "one", "Not Started"),
        storage_trello.Card(2, "two", "Done"),
...
def test_get_done_items_mongo():
    """! This tests assumes what persistence layer will return into ViewModel"""
    A, B, C, D = (
        storage_mongo.Card(1, "one", "Not Started"),
        storage_mongo.Card(2, "two", "Done"),
        storage_mongo.Card(3, "three", "Not Started"),
        storage_mongo.Card(4, "four", "Done"),
    )
